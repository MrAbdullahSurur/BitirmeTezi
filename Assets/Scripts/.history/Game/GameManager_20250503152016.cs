...
public class GameManager : NetworkBehaviour
{
    ...
    private void ShowGameOver()
    {
        ...
        if (_gameOverPanel != null)
        {
            ...
            {
                // Log the state of the ScoreController's NetworkVariable directly
                finalScore = _scoreController.Score;
                Debug.Log($"GameManager.ShowGameOver: Reading score from ScoreController. Current Value = {finalScore}. IsServer={IsServer}, IsClient={IsClient}");
            }
            else
            {
