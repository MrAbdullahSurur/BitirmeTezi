...
public class PlayerMovement : NetworkBehaviour
{
    ...
    private void ConnectUIElements()
    {
        ...
        if (healthBar != null && healthController != null)
        {
            ...
            Debug.Log($"Player {OwnerClientId} connected its HealthController to HealthBarUI.");
        }
        else
        {
            Debug.LogWarning($"Player {OwnerClientId} could not find HealthBarUI or HealthController to connect.");
        }
        
        // Score UI (ScoreController bunu zaten yapıyor ama emin olmak için eklenebilir)
