...
public class PlayerMovement : NetworkBehaviour
{
    ...
    private void SetPlayerVelocity()
    {
        ...
        {
            Debug.Log($"[{Time.frameCount}] SetPlayerVelocity: Player {OwnerClientId} - Input: {_movementInput}, Smoothed: {_smoothedMovementInput}, Final Velocity: {_rigidbody.velocity}", this);
        }
