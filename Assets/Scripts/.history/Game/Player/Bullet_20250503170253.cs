...
public class Bullet : NetworkBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (collision.GetComponent<EnemyMovement>() != null)
        {
            ...
            // Register who damaged this enemy for score allocation
            ...
            if (scoreAllocator != null)
            {
                ...
                Debug.Log($"Bullet from player {_ownerClientId} (prefab: {gameObject.name}) hit an enemy! Score will be allocated.");
            }
