...
public class PlayerMovement : NetworkBehaviour
{
    ...
    */
    ...
    {
        // Wait a tiny bit for scene objects to potentially initialize
        yield return new WaitForEndOfFrame(); 
        // yield return new WaitForSeconds(0.1f); // Alternative delay if EndOfFrame isn't enough
        
        SetCameraTarget(); // Now call the actual logic
    }
