...
public class PlayerMovement : NetworkBehaviour
{
    ...
    public override void OnNetworkSpawn()
    {
        ...
        if (IsOwner)
        {
            ...
            if (IsHost)
            {
                ...
                _playerInput.SwitchCurrentActionMap("PlayerWASD"); 
                 Debug.Log($"Host {OwnerClientId}: Enabling PlayerInput with map: {_playerInput.currentActionMap.name}");
            }
            else 
            {
                 ...
                 try 
                 {
                      ...
                      Debug.Log($"Client {OwnerClientId}: Enabling PlayerInput with map: PlayerArrows");
                 }
        ...
        else
        {
             ...
             _playerInput.DeactivateInput(); // Input işlemini de durdur
             Debug.Log($"NonOwner {OwnerClientId}: Disabled PlayerInput.");
